...
@section('content')
    ...
    @if(!$visible)
    <div class="container">
        <div class="alert">non ci sta niente</div>
    </div>
    @else
    <div class="container pt-5">
        <h3>Your apartments</h3>
        <div class="row py-4 justify-content-between">
            ...
            <div class="col-sm-2">
                <div>
                    <a class="see_all_link" href="{{ route('admin.accommodation.index', $accommodation->id) }}">See all</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container pt-5">
        ...
        <div class="row py-4 justify-content-between">
            ...
            <div class="col-sm-2">
                <div>
                    <a class="see_all_link" href="#">See all</a>
                </div>
            </div>
        </div>
    </div>
