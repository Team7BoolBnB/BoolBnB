            ...
            <div class="heroOverlay">
                <div class="h-100 d-flex justify-content-center align-items-center">
                    <div class="container_link_advanced d-flex flex-column justify-content-center align-items-center">
                        ...
                        <p class="text-center py-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
                            eiusmod tempor incididunt.</p>
                        <router-link :to="{ name: 'advanced-search' }" class="basicBtn bigBtn primaryBtn">Start search
                        </router-link>
                    </div>
                </div>
            </div>
...
.debug_carosel {
    height: 50vh;
    background-color: rgb(157, 107, 130);
