  ...
  <div v-if="check" class="position-relative">
    ...
    <div class="container py-5">
      ...
      <div class="row container-img mb-5">
        ...
        <div class="col-4">
          <div class="py-3">
            <img class="w-100 img_debug img-smollest-display" src="https://www.google.com/maps/d/thumbnail?mid=1R-z0nvlZTWYN9LH3bxAtMhZScxo&hl=it" :alt="'Accommodation of ' + accommodation[0].title" />
          </div>
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-8">
          <div>
            ...
            <p class="py-4 text-break" v-html="accommodation[0].description"></p>
            ...
            <div class="py-2 px-2">
              ...
              <form @submit.prevent="onFormSubmit">
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" v-model="name" id="nameInput" placeholder="John Doe"/>
                </div>
                <div class="mb-3">
                  <label for="emailInput" class="form-label"><p class="mb-0">Email</p></label>
                  <input type="email" class="form-control" v-model="email" id="emailInput" placeholder="name@example.com"/>
                </div>
                <div class="mb-3">
...
export default {
    components: { NavBar, AtomSpinner, TheFooter },
  data() {
    return {
      endAlert: true,
      content: "",
